...
export default function ProductCard({ product }: { product: ApiProduct }) {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-lg border border-border bg-background transition-all duration-300 hover:shadow-lg">
      <Link
        href={href}
        className="relative block aspect-[3/4] shrink-0 overflow-hidden bg-cream"
      ...
      <div className="flex flex-1 flex-col p-4">
        <div className="flex-1">
          <Link href={href}>
            <h3 className="line-clamp-1 font-display text-lg font-semibold text-foreground group-hover:text-rose-deep">
              {product.name}
            </h3>
          </Link>
