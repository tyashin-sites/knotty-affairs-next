...
// pageMetadata gives the index a canonical (/blog) so the ?tag=/?page=
// permutations consolidate onto one URL instead of splitting signals.
export const metadata = pageMetadata({
  title: 'Blog',
  description:
    'Styling notes, fabric stories and fit guides from Knotty Affairs by Mridul — designer womenswear for the modern Indian silhouette.',
  path: '/blog',
});
        ...
        <section className="bg-cream py-10 md:py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="font-display text-3xl font-bold text-foreground md:text-4xl">
              {sp.tag ? `Posts tagged "${sp.tag}"` : sp.category ? sp.category : 'The Knotty Affairs Journal'}
            </h1>
            {!sp.tag && !sp.category && (
