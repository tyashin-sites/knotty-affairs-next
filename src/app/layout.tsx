...
// Self-hosted, preloaded, swap. Cormorant italic carries the romance beat of
// the script logo; Jost keeps the urban, geometric counterpoint (DESIGN-SPEC).
 ...
 * via the storefront's own origin (www.knottyaffairsbymridul.com or any dispatched host).
...
export const metadata: Metadata = {
  ...
  robots: ROBOTS_NOINDEX
    ...
    : undefined,
  openGraph: {
    title: 'Knotty Affairs by Mridul — Designer Womenswear, Tailored for You',
    description:
      'Sustainable designer womenswear for the modern Indian silhouette. Tops, shirts, co-ord sets, dresses. Shipping across India.',
    type: 'website',
    url: siteUrl('/'),
    siteName: SITE.name,
    locale: SITE.locale,
  ...
  twitter: {
    ...
    title: 'Knotty Affairs by Mridul — Designer Womenswear, Tailored for You',
    description:
      'Sustainable designer womenswear for the modern Indian silhouette. Shipping across India.',
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <html lang="en" className={`${display.variable} ${body.variable}`} style={{ backgroundColor: '#FBF9F6' }}>
      <head>
